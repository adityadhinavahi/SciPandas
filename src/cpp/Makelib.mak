...
OBJS = PyVar.obj
OBJS_WITH_PATH = Release/PyVar.obj
# ------------------------------------------------------
# added libraries
...
#CC = 
# ------------------------------------------------------
CFLAGS = $(CC_OPTIONS) -D__SCILAB_TOOLBOX__ -DFORDLL  -I"F:\downloads\SciPandas-0.1\SciPandas-0.1\SciPandas-0.1\src\cpp"  -I"F:\downloads\SciPandas-0.1\SciPandas-0.1\SciPandas-0.1\python\include"  -I"C:\Program Files\scilab-6.1.0\modules\ast\includes" -DSCIPANDAS_EXPORTS -DNDEBUG -DLIBPYVAR_GW_EXPORTS  
# ------------------------------------------------------
FFLAGS = $(FC_OPTIONS) -DFORDLL  
# ------------------------------------------------------
EXTRA_LDFLAGS = F:\downloads\SciPandas-0.1\SciPandas-0.1\SciPandas-0.1\src\cpp\..\..\python\libs\python38.lib
# ------------------------------------------------------
